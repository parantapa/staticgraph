...
ext_modules = [
    ...
    Extension("staticgraph.digraph_edgelist",
              ...
              include_dirs=[get_include()]),
    Extension("staticgraph.weightedgraph_edgelist",
              ["staticgraph/weightedgraph_edgelist.pyx"],
              include_dirs=[get_include()]),
    Extension("staticgraph.w_digraph_edgelist",
              ["staticgraph/w_digraph_edgelist.pyx"],
              include_dirs=[get_include()]),
